...
{
    public partial class UC_BaoCaoDoanhSoVTTheoThangcs : UserControl
    {
        public UC_BaoCaoDoanhSoVTTheoThangcs()
        {
            InitializeComponent();
        }
        ...
        public static UC_BaoCaoDoanhSoVTTheoThangcs UcBCDSVTTT = new UC_BaoCaoDoanhSoVTTheoThangcs();
        ...
        private void btnTim_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = db.BCDSVTTT(dtNgay1.Value.ToString("yyyy-MM-dd"), dtNgay2.Value.ToString("yyyy-MM-dd"), VatTu);
        ...
        private void UC_BaoCaoDoanhSoVTTheoThangcs_Load(object sender, EventArgs e)
        {
