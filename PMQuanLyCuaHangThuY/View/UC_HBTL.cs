...
{
    public partial class UC_HBTL : UserControl
    {
        public static UC_HBTL ucHBTL = new UC_HBTL();
        ...
        private void UC_HBTL_Load(object sender, EventArgs e)
        {
        ...
        {
            save = true;
            FormHBTLThongTin frm = new FormHBTLThongTin();
        ...
        {
            FormHBTLDinhChi frm = new FormHBTLDinhChi();
